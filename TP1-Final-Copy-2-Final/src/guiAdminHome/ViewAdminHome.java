...
public class ViewAdminHome {
	...
	*/
	...
	protected static Button button_Requests = new Button("Requests");
	...
	*/
	...
	public static void displayAdminHome(Stage ps, User user) {
		...
		//Set the labels for users and invites before opening the page
	...
	private ViewAdminHome() {
		...
		button_Discussion.setOnAction((event) -> {ControllerAdminHome.goToDiscussion(); });
		...
		setupButtonUI(button_Requests, "Dialog", 16, 250, Pos.CENTER, 300, 420);
		button_Requests.setOnAction((event) -> {ControllerAdminHome.adminRequests(); });
