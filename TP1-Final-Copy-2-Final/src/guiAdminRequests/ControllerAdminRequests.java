	...
	*/
	...
	protected static void performAddDocumentation() {
		if (ModelAdminRequests.selectedRequest == null) return;
		 ...
		 ViewAdminRequests.theRootPane.getChildren().addAll(
				 ViewAdminRequests.text_addDocs, ViewAdminRequests.button_back);
	}
	...
	protected static void performViewDocumentation() {
		if (ModelAdminRequests.selectedRequest == null) return;
		 ...
		 ViewAdminRequests.theRootPane.getChildren().addAll(
				 ViewAdminRequests.vbox_docs, ViewAdminRequests.button_back);
	...
	protected static void performSubmit() {
		ModelAdminRequests.selectedRequest.addDocumentation(ViewAdminRequests.text_addDocs.getText());
		try {
			theDatabase.register(ModelAdminRequests.selectedRequest);
	...
	protected static void repaintTheWindow() {
		...
		if (ModelAdminRequests.selectedRequest == null) {
			...
			ViewAdminRequests.theRootPane.getChildren().addAll(
					ViewAdminRequests.titleLabel, ViewAdminRequests.instructionLabel,
		...
		ViewAdminRequests.theStage.setScene(ViewAdminRequests.theAdminRequestsScene);
