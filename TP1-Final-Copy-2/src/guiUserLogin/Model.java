...
public class Model {
	...
	protected static void checkUsername() {
		ViewUserLogin.resetUsernameDisplay();   //resets Username Display
		String username = ViewUserLogin.text_Username.getText(); // Fetches input from text input for username
		// If the input is empty, clear the display
		if (username.isEmpty()) {
			ViewUserLogin.resetUsernameDisplay();  // Reset the password requirements to be blank
		} else { 
	...
	private static void updateUNFlags() {
		ViewUserLogin.resetPasswordDisplay();
		ViewUserLogin.resetComparisonDisplay();
		ViewUserLogin.label_UNRequirements.setText("These are the Username requirements: ");
		ViewUserLogin.label_UNRequirements.setTextFill(Color.BLACK);
		if (foundAlphabetic) {
			ViewUserLogin.label_Alphabetic.setText("The First Character Must be a letter (A-Z or a-z) - Satisfied");
			ViewUserLogin.label_Alphabetic.setTextFill(Color.GREEN);
		} else {
			ViewUserLogin.label_Alphabetic.setText("The First Character Must be a letter (A-Z or a-z) - Not Satisified");
			ViewUserLogin.label_Alphabetic.setTextFill(Color.RED);
		}
		if (foundSPChar) {
			ViewUserLogin.label_SPChar.setText("The Username may contain a period, dash, or underscore (.,-,_)\n"
				+ "if it is followed by an alphanumerica character (A-Z, a-z, 0-9) - Not Satisified");
			ViewUserLogin.label_SPChar.setTextFill(Color.RED);
		} else {
			ViewUserLogin.label_SPChar.setText("The Username may contain a period, dash, or underscore (.,-,_)\n"
				+ "if it is followed by an alphanumerica character (A-Z, a-z, 0-9) - Satisified");
			ViewUserLogin.label_SPChar.setTextFill(Color.GREEN);
		}
		if (foundUNLongEnough) {
			ViewUserLogin.label_UNLongEnough.setText("At least four characters - Satisfied");
			ViewUserLogin.label_UNLongEnough.setTextFill(Color.GREEN);
		} else {
			ViewUserLogin.label_UNLongEnough.setText("At least four characters - Not Satisfied");
			ViewUserLogin.label_UNLongEnough.setTextFill(Color.RED);
		}
		if (foundUNTooLong) {
			ViewUserLogin.label_UNTooLong.setText("At most sixteen characters - Not Satisfied");
			ViewUserLogin.label_UNTooLong.setTextFill(Color.RED);
		} else {
			ViewUserLogin.label_UNTooLong.setText("At most sixteen characters - Satisfied");
			ViewUserLogin.label_UNTooLong.setTextFill(Color.GREEN);
		}
		if (validUsername) {
			ViewUserLogin.label_validUsername.setText("The Username is valid!");
			ViewUserLogin.label_validUsername.setTextFill(Color.GREEN);
		} else {
			ViewUserLogin.label_validUsername.setText("The Username is not valid!");
			ViewUserLogin.label_validUsername.setTextFill(Color.RED);
		}
	}
	...
	protected static void checkPassword() {
		ViewUserLogin.resetPasswordDisplay();   //resets Password Display
		String password = ViewUserLogin.text_Password.getText(); // Fetches input from text input for password
		// If the input is empty, clear the display
		if (password.isEmpty()) {
			ViewUserLogin.resetPasswordDisplay();  // Reset the password requirements to be blank
		} else { 
		...
		if (errMessage != "") { 
			...
			ViewUserLogin.errPasswordPart1.setText(password.substring(0, pwIndexofError));
			// The red arrow
			ViewUserLogin.errPasswordPart2.setText("\u21EB");
			// Tell the user about the meaning of the red up arrow
			ViewUserLogin.errPasswordPart3.setText("The red arrow points at the character causing the error!");
			// Tell the user that the password is not valid with a red message
			ViewUserLogin.validPassword.setTextFill(Color.RED);
			ViewUserLogin.validPassword.setText("Failure! The password is not valid.");
			...
			updatePWFlags();
			ViewUserLogin.errPasswordPart1.setText("");
			ViewUserLogin.errPasswordPart2.setText("");
			ViewUserLogin.errPasswordPart3.setText("");
			// Tell the user that the password is valid with a green message
			ViewUserLogin.validPassword.setTextFill(Color.GREEN);
			ViewUserLogin.validPassword.setText("Success! The password satisfies the requirements.");
	...
	private static void updatePWFlags() {
		ViewUserLogin.resetUsernameDisplay();
		ViewUserLogin.resetComparisonDisplay();
		ViewUserLogin.label_Requirements.setText("These are the pasword requirements: ");
		ViewUserLogin.label_Requirements.setTextFill(Color.BLACK);
		if (foundUpperCase) {
			ViewUserLogin.label_UpperCase.setText("At least one upper case letter - Satisfied");
			ViewUserLogin.label_UpperCase.setTextFill(Color.GREEN);
		} else {
			ViewUserLogin.label_UpperCase.setText("At least one upper case letter - Not Satisfied");
			ViewUserLogin.label_UpperCase.setTextFill(Color.RED);
		}
		if (foundLowerCase) {
			ViewUserLogin.label_LowerCase.setText("At least one lower case letter - Satisfied");
			ViewUserLogin.label_LowerCase.setTextFill(Color.GREEN);
		} else {
			ViewUserLogin.label_LowerCase.setText("At least one lower case letter - Not Satisfied");
			ViewUserLogin.label_LowerCase.setTextFill(Color.RED);
		}
		if (foundNumericDigit) {
			ViewUserLogin.label_NumericDigit.setText("At least one numeric digit - Satisfied");
			ViewUserLogin.label_NumericDigit.setTextFill(Color.GREEN);
		} else {
			ViewUserLogin.label_NumericDigit.setText("At least one numeric digit - Not Satisfied");
			ViewUserLogin.label_NumericDigit.setTextFill(Color.RED);
		}
		if (foundSpecialChar) {
			ViewUserLogin.label_SpecialChar.setText("At least one special character - Satisfied");
			ViewUserLogin.label_SpecialChar.setTextFill(Color.GREEN);
		} else {
			ViewUserLogin.label_SpecialChar.setText("At least one special character - Not Satisfied");
			ViewUserLogin.label_SpecialChar.setTextFill(Color.RED);
		}
		if (foundLongEnough) {
			ViewUserLogin.label_LongEnough.setText("At least eight characters - Satisfied");
			ViewUserLogin.label_LongEnough.setTextFill(Color.GREEN);
		} else {
			ViewUserLogin.label_LongEnough.setText("At least eight characters - Not Satisfied");
			ViewUserLogin.label_LongEnough.setTextFill(Color.RED);
		}
		if (foundTooLong) {
			ViewUserLogin.label_TooLong.setText("At most thirty-two characters - Not Satisfied");
			ViewUserLogin.label_TooLong.setTextFill(Color.RED);
		} else {
			ViewUserLogin.label_TooLong.setText("At most thirty-two characters - Satisfied");
			ViewUserLogin.label_TooLong.setTextFill(Color.GREEN);
		}
	}
	...
	public static void adminButtonEnabled() {
		if (validUsername && validPassword) {
			ViewUserLogin.button_Login.setDisable(false); 
		return;
		} else {
		System.out.println("Not Valid");
		ViewUserLogin.button_Login.setDisable(true); 
		return;
		}
	}
}
